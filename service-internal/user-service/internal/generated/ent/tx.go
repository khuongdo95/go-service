...
func (tx *Tx) init() {
	tx.IPAccessControl = NewIPAccessControlClient(tx.config)
	tx.Identity = NewIdentityClient(tx.config)
	tx.User = NewUserClient(tx.config)
	tx.UserIpWhiteList = NewUserIpWhiteListClient(tx.config)
}
...
// applies a query, for example: IPAccessControl.QueryXXX(), the query will be executed
